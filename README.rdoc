...
To get around this problem, Fech, by default, uses the following steps to parse each line in a filing:
...
If you'd like to parse an entire filing using a different CSV quote character, see the section below.
